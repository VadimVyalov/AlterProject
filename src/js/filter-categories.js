...
import { makeData, dataSectionNormalize, arrLastData } from './apiNews';
...
export function restart() {
  ...
  valuePage.totalPage = Math.ceil(countSearch.newsCount / countSearch.perPage);
  ...
  switch (lastSeacrh.type) {
    case 'SECTION':
      break;
    case 'SEARCHE':
      countSearch.newsCount = countSearch.perPage * 100;
      break;
    case 'POPULAR':
      countSearch.newsCount = 20;
      break;
  }
